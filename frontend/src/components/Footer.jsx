            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
                    ...
                    <div className="lg:col-span-2">
                        ...
                        >
                            ...
                            <p className="text-gray-400 mb-6 max-w-md">
                                Building lightning-fast, secure applications with a focus on performance optimization 
                                and scalable architecture. From frontend to backend, I deliver solutions that scale.
                            </p>
                            <div className="flex space-x-4">
                                <a
                                    href="https://github.com/CovetingAphid3"
                                    target="_blank"
                    ...
                    >
                        ...
                        <ul className="space-y-2">
                            ...
                            <li>
                                <span className="text-gray-400">VPS Deployment</span>
                            </li>
                            <li>
                                <span className="text-gray-400">Security Auditing</span>
                            </li>
                        </ul>
                    </motion.div>
                </div>
                ...
                >
                    <p className="text-gray-400 text-sm mb-4 md:mb-0">
                        © {currentYear} Full-Stack Developer & Security Expert. All rights reserved.
                    </p>
                    <button
                        onClick={scrollToTop}
